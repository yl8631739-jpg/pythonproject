    ...
    def get(self, url, data, header):
        ...
        try:
            if data is None:
                ...
                response = requests.get(url, params=data, headers=header, cookies=self.cookie, verify=False)
    ...
    def post(self, url, data, header):
        ...
        try:
            if data is None:
                ...
                response = requests.post(url, data=data, headers=header, cookies=self.cookie, verify=False)
        except requests.RequestException as e:
            logs.error(e)
            return None
        except Exception as e:
